...
@section('content')
<section class="bg-top bg-no-repeat bg-contain -mt-28">
  <div class="flex container mx-auto justify-evenly items-center">
    <div class="top-intro leading-8">
    ...
    <img src="@asset('images/development.svg')" alt="专注于开发" width="450px" class="my-28">
  </div>
  <div class="flex flex-wrap justify-evenly pt-8 pb-20 container mx-auto text-3xl">
    <div class="hover-up-5 shadow px-10 py-16 rounded-md bg-white">
      10+年开发经验
    </div>
    <div class="hover-up-5 shadow px-10 py-16 rounded-md bg-white">
      100+客户支持
  ...
  <div class="bg-grey">
    <div class="container mx-auto py-16">
      <div class="bg-white text-center p-16 shadow leading-7 rounded-md">
        ...
        <div class="flex gap-x-20 our-services">
